                ...
                <Col md={9}>
                    ...
                    <div className="d-flex justify-content-md-end align-items-center">
                        ...
                        {exportData.length !== 0 ? (
                            <ExcelFile
                                filename="Мои оценки"
                                element={<button type="button" className="btn btn-success float-right m-3">Экпорт оценок</button>}>
                                <ExcelSheet dataSet={DataSet} name="Мои оценки"/>
                            </ExcelFile>
                        ): null}
